...
- The project is open source. You can build up your robot for free (only hardware costs).
- The project use standard hardware like stepper, driver, electronics. You can buy it as you like.
- The project is open-source. Change the code by yourself for your needs.
